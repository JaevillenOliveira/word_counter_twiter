...
query_params = {'max_results': 500, 'query': 'place_country:BR', 'until_id':"1566112364415664130"}

file_path = '/home/jaevillen/Ecomp/word_counter_twiter/tweets/'
...
def main():
    ...
    while count < 200000:
        countToDelay120 = 0
        while countToDelay120 < 200000:
            countToDelay60 = 0
            while countToDelay60 < 50000:
